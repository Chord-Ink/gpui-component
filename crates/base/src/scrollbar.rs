...
impl Element for Scrollbar {
    ...
    fn paint(
        ...
        window.with_content_mask(Some(ContentMask::new(hitbox_bounds)), |window| {
...
mod tests {
    ...
    fn unstyled_thumb_follows_the_theme_rather_than_a_fixed_colour(cx: &mut TestAppContext) {
        cx.update(|cx| {
            ...
            crate::Theme::update(cx, |theme| {
                ...
                tokens.colors.foreground = light;
    ...
    fn a_styled_thumb_still_beats_the_theme_derived_default(cx: &mut TestAppContext) {
        cx.update(|cx| {
            ...
            crate::Theme::update(cx, |theme| {
                let mut tokens = theme.tokens().clone();
                tokens.colors.foreground = gpui::hsla(0., 0., 0.98, 1.0);
                theme.with_tokens(tokens)
            });
    ...
    fn instance_styles_override_theme_scrollbar_defaults(cx: &mut TestAppContext) {
        cx.update(|cx| {
            ...
            crate::Theme::update(cx, |theme| {
                theme.with_scrollbar(
                    crate::ScrollbarTheme::new()
